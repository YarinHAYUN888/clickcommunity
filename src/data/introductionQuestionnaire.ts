...
export const INTRODUCTION_QUESTIONS: IntroductionQuestion[] = [
  {
    id: 'community_pull',
    title: 'מה מושך אותך להצטרף לקהילה כזו, ובמה את או אתה מקווים להפיק ערך?',
    hint: 'משפטים קצרים וכנים — זה עוזר לנו להבין אם זה המקום הנכון בשבילך.',
    type: 'textarea',
    required: true,
    minLength: 30,
    maxLength: 500,
    placeholder: 'לדוגמה: אני מחפש/ת חיבור אמיתי לאנשים ש...',
  },
  {
    id: 'weekend_vibe',
    title: 'איך נראה אצלכם סופ״ש מוצלח? תארו בקצרה.',
    type: 'textarea',
    required: true,
    minLength: 20,
    maxLength: 320,
    placeholder: 'פעילות בחוץ, מפגשים עם חברים, זמן שקט...',
  },
  {
    id: 'people_seek',
    title: 'איזה סוג אנשים תשמחו לפגוש כאן?',
    type: 'textarea',
    required: true,
    minLength: 20,
    maxLength: 320,
    placeholder: 'אנשים פתוחים, יצירתיים, רציניים בקשרים...',
  },
  {
    id: 'social_events_exp',
    title: 'איך הייתם מתארים את הניסיון שלכם במפגשים חברתיים או קהילתיים?',
    type: 'select',
    required: true,
    minLength: 1,
    maxLength: 40,
    options: [
      { value: 'rarely', label: 'כמעט ולא — זה חדש עבורי' },
      { value: 'sometimes', label: 'מדי פעם, בקצב נוח' },
      { value: 'often', label: 'מדי פעם או לעיתים קרובות' },
      { value: 'very_often', label: 'אני ממש פעיל/ה במפגשים כאלה' },
    ],
  },
  {
    id: 'first_meet_values',
    title: 'מה הכי חשוב לכם במפגש ראשון עם חבר חדש מהקהילה?',
    type: 'textarea',
    required: true,
    minLength: 20,
    maxLength: 400,
    placeholder: 'כנהות, כבוד, הומור, שיחה עמוקה...',
  },
  {
    id: 'extra_context',
    title: 'יש משהו שחשוב לכם שנדע מראש? (אופציונלי)',
    hint: 'רק אם רלוונטי — ניתן להשאיר ריק.',
    type: 'textarea',
    required: false,
    minLength: 0,
    maxLength: 400,
    placeholder: 'למשל העדפות נגישות, שפה, או כל דבר שיחסוך אי-הבנות.',
  },
];
